...
/**
 * OAuth2资源所有者基础认证提供者抽象类,用于处理资源所有者密码凭证授权流程,OAuth2资源所有者基础认证令牌类型
 */
@Slf4j
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
    ...
    /**
     * 设置刷新令牌生成器
     * refreshTokenGenerator 刷新令牌生成器,不能为null
     */
    @Deprecated
     ...
     * authentication 认证请求对象
     * 包含凭证的完整认证对象，如果当前认证提供者无法处理传入的认证对象可能返回null
     */
    @Override
